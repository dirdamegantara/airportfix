...
<body class="text-gray-900">
    ...
    <form method="POST" action="{{route('storedata_keberangkatan')}}">
        @csrf
        <div class="w-3/4 mx-auto bg-white rounded-lg overflow-hidden shadow-lg p-8">
            <div class="bg-gray-800 rounded-lg text-center py-4">
                <h2 class="text-xl front-bold text-white">Tambah Data keberangkatan</h2>
            </div>
            <div class="p-6">
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="tujuan" name="tujuan" class="border border-gray-300 rounded-md py-2 px-3 w-full @error('tujuan') is-invalid @enderror" value="{{old('tujuan')}}">
                </div>
                {{--Alert --}}
                @error('tujuan')
                    <div class="bg-orange-100 border-1-4 border-orange-500 text-orange-700 p-4" role="alert">
                ...
                <div class="mb-4">
                    ...
                    <input type="time" id="waktu_keberangkatan" name="waktu_keberangkatan" class="border border-gray-300 rounded-md py-2 px-3 w-full @error('waktu_keberangkatan') is-invalid @enderror" value="{{old('waktu_keberangkatan')}}">
                </div>
                {{--Alert --}}
