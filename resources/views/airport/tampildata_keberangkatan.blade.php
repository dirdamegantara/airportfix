    ...
    <div class="container mx-auto">
        <div class="w-3/4 mx-auto bg-white rounded-lg overflow-hidden shadow-lg p-8">
            <div class="bg-gray-800 rounded-lg text-center py-4">
                <h2 class="text-xl front-bold text-white">Data keberangkatan</h2>
            </div>
            <div class="p-6">
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <a href="{{route('editdata_keberangkatan',$keberangkatan->id)}}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded inline-block mb-1">Ubah</a>
                </div>
            </div>
        </div>
    </div>
